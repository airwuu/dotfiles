...

{
    programs.vscode = {
        ...
        userSettings = {
            ...
            "leetcode.workspaceFolder": "/home/rem/.leetcode",
            ...
            "vscord.status.details.text.editing": "{workspace}",
            "vscord.status.details.text.idle": "Idle",
            "vscord.status.details.text.viewing": "In {workspace}",
            "vscord.status.state.text.editing": "{file_name}{file_extension} (L:{current_line} C:{current_column})",
